...
class MetroController(
    ...
    @Operation(summary = "도착 예정 열차 조회", description = "지하철 역에 도착 예정인 열차를 조회합니다.")
    ...
    @Operation(summary = "열차 칸별 혼잡도 조회", description = "열차의 칸별 혼잡도를 조회합니다.")
    ...
    @Operation(summary = "열차 추천", description = "열차의 상태와 회원의 선호도를 기반으로 열차를 추천합니다.")
